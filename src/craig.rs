...
fn test() {
    ...
    craig.label_var(v1, VarLabel::Global);
    craig.label_var(v2, VarLabel::Global);
    ...
    craig.label_clause(ClauseLabel::A);
    solver.add_clause(&[Lit::new(v1, true)]);
    craig.label_clause(ClauseLabel::B);
    solver.add_clause(&[Lit::new(v1, false), Lit::new(v2, true)]);
    craig.label_clause(ClauseLabel::B);
    solver.add_clause(&[Lit::new(v1, true), Lit::new(v3, true)]);
    craig.label_clause(ClauseLabel::B);
    solver.add_clause(&[Lit::new(v3, false)]);
    dbg!(solver.solve(&[]));
